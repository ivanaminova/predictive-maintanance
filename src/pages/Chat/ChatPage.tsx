    ...
    <div className="w-[1000px] h-[600px] mx-32 flex flex-col">
      ...
      <div className="pt-4 pb-4">
        <div className="flex flex-col items-center text-center">
          <h2 className="text-xl font-semibold text-secondary-foreground px-4">
            AI Assistant
          </h2>
          <div className="h-0.5 w-1/2 bg-secondary-foreground rounded-full mt-2"></div>
        </div>
      </div>
      ...
      >
        {messages.map((message) => (
          <div
            key={message.id}
            className={cn(
              "max-w-[55%] rounded-lg p-3 break-words transition-all duration-300",
              message.sender === "user"
