    ...
    <div className="m-36 h-full">
      <Card className="border border-border">
        ...
        <CardContent className="flex flex-row gap-8">
          ...
          {/* Column 2: deploy + dashboard */}
          <div className="flex flex-col flex-1 gap-4 items-end">
            {completedTraining ? (
